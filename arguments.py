...
parser.add_argument('-mod',"--model_name",help="Specify model to train (NF, CSRNet, UNet, UNet_seg,FCRN, LCFCN).",default='UNet_seg')
...
parser.add_argument('-adam_e',help='choose adam episilon',type=float,default=1e-8)
parser.add_argument('-sgd_mom',help='choose sgd momentum',type=float,default=0.9)
...
#if args.model_name == 'UNet_seg':
#    assert args.dmap_type == 'max'
